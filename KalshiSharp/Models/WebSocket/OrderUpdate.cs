...
{
    /// <inheritdoc/>
    public override string MessageType => "user_order";
    ...
    public sealed record MessageBody
    {
        ...
        /// Replaces the legacy <see cref="Side"/> field.
        /// </summary>
        [JsonPropertyName("outcome_side")]
        public required OrderSide OutcomeSide { get; init; }
        ...
        public required OrderBookSide BookSide { get; init; }
        ...
        /// <summary>
        /// Returns the YES-quoted price. V2 always quotes in YES terms.
        /// </summary>
        [JsonIgnore]
        public string OrderPrice => YesPriceDollars;
    }
}
