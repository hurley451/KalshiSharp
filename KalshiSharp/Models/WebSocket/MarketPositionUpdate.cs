...
/// <summary>Real-time market-position update for the authenticated user.</summary>
public sealed record MarketPositionUpdate : WebSocketMessage<MarketPositionUpdate.MessageBody>
{
        ...
        public sealed record MessageBody
        {
            ...
            */
            ...
            /// <summary>
            /// Current cost basis of the position in dollars.
            /// </summary>
            [JsonPropertyName("position_cost_dollars")]
            public string? PositionCostDollars { get; init; }

            /// <summary>
            /// Realized profit/loss in dollars.
            /// </summary>
            [JsonPropertyName("realized_pnl_dollars")]
            public string? RealizedPnlDollars { get; init; }

            /// <summary>
            /// Total fees paid in dollars.
            /// </summary>
            [JsonPropertyName("fees_paid_dollars")]
            public string? FeesPaidDollars { get; init; }

            /// <summary>
            /// Total position fee cost in dollars.
            /// </summary>
            [JsonPropertyName("position_fee_cost_dollars")]
            public string? PositionFeeCostDollars { get; init; }
            ...
            /// <summary>Unix timestamp in milliseconds, when supplied.</summary>
