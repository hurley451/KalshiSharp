...
public sealed record CreateOrderRequestV2
{
    ...
    /// Use <see cref="EventOrderTimeInForce.GoodTillCanceled"/> with <see cref="ExpirationTime"/> for a GTT order.
    /// <see cref="EventOrderTimeInForce.ImmediateOrCancel"/> cannot be combined with <see cref="ExpirationTime"/>.
    /// </summary>
    public required EventOrderTimeInForce TimeInForce { get; init; }
    ...
    /// Only valid when <see cref="TimeInForce"/> is <see cref="EventOrderTimeInForce.GoodTillCanceled"/>.
    /// </summary>
